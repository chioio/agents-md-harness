---
title: fe-todo-app-harness-readme
project: fe-todo-app
language: zh-CN
layer: harness
---
...
这是 `fe-todo-app` 的模块化 harness 说明层。

它用于支持一个基于 Vite 8、React、TanStack Router、Tailwind CSS 4 的 TODO App，并验证前端项目中的 agent 工作方式是否稳定、可读、可组合。
...
- 支持 memory、GC 与真实前端工作流测试

## 项目上下文

该项目是一个前端 TODO App 样例，主要用于验证：
